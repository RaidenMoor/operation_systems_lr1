...
int main() {
    ...
    printf("Лабораторная работа №1/nВариант №7/nВыполнила Гусева Мария Студентка группы 6401-020302D");
    printf("Индивидуальное задание: Транспонировать матрицу, размещенную в динамическом массиве размерности N×N, не используя дополнительного массива.");
