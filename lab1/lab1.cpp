...
int main() {
    ...
    printf("Лабораторная работа №1\nВариант №7\nВыполнила Гусева Мария Студентка группы 6401-020302D\n");
    printf("Индивидуальное задание: \nТранспонировать матрицу, размещенную в динамическом массиве размерности NxN, \nне используя дополнительного массива.\n");
